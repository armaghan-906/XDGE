...
export function TopBar() {
  ...
  return (
    <motion.div
      ...
      style={{ display: 'flex', justifyContent: 'space-between', padding: '24px 40px 0', alignItems: 'center' }}
    >
      <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
        ...
        >X</div>
        <div style={{ fontSize: 11, lineHeight: 1.35, color: theme.base, letterSpacing: '0.04em', paddingTop: 1, whiteSpace: 'nowrap' }}>
